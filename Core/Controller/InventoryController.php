...
switch($action) {
    ...
    case 'readOne': $controller->readOne($_GET['id'] ?? 0); break;
    case 'searchByProductId': $controller->searchByProductId($_GET['product_id'] ?? 0); break;
    case 'recalculateStock': $controller->recalculateStock($_GET['product_id'] ?? 0); break;
    case 'update': $controller->update($_GET['id'] ?? 0); break;
    case 'delete': $controller->delete($_GET['id'] ?? 0); break;
    case 'GetAllProducts': $controller->GetAllProducts(); break;
    default:
